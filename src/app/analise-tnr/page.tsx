...
import MunicipiosTnrDashboard from "@/components/censo/MunicipiosTnrDashboard";
import EscolasTnrDashboard from "@/components/censo/EscolasTnrDashboard";
import { motion, AnimatePresence } from "framer-motion";
import { ShieldAlert, Globe2, MapPin, School } from "lucide-react";
...
export default function AnaliseTnrPage() {
  ...
  return (
    <MainLayout title="Taxa de Não Resposta — Ensino Fundamental e Médio (2022-2025)">
      <div className="mb-12 flex flex-col items-center text-center">
        ...
        <p className="text-gray-500 max-w-2xl text-lg leading-relaxed">
          Percentual de alunos sem situação de rendimento declarada no Censo Escolar (2022–2025) —
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {escopo === "estado" && <TnrDashboard />}
          {escopo === "municipios" && <MunicipiosTnrDashboard />}
          {escopo === "escolas" && <EscolasTnrDashboard />}
        </motion.div>
      </AnimatePresence>
    </MainLayout>
  );
